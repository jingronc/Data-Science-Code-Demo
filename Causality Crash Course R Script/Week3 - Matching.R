...
#look at a table 1 to compare treatment vs control across covariates
...
#(dont need to fit a logistic regression first)
...
#plot(m.out,type="jitter") useless chart
plot(m.out,type="hist")

#do greedy matching on logit(PS) using Match with a caliper
#caliper = 0.2*logit(std(propensity score))
